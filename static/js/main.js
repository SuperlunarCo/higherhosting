      ...
      C.extend({
        ...
        isPlainObject: function (e) {
          return !(
            ...
            ((e = L(e)) &&
              ("function" !=
                typeof (e = q.call(e, "constructor") && e.constructor) ||
                W.call(e) !== U))
          );
        },
        ...
        return (
          ...
          (f = F.tokenize =
            function (e, t) {
              ...
              return t ? s.length : s ? F.error(e) : q(e, a).slice(0);
            }),
          (N = F.compile =
            function (e, t) {
              var n,
  ...
  !(function (e, t) {
    ...
    (Ee.exports = function (e, t, n, i) {
      var o,
        ...
        i = !!i && !!i.noTargetGet;
      "function" == typeof n &&
        ("string" != typeof t || qe(n, "name") || ze(n, "name", t),
        (o = Ye(n)).source ||
      ...
      if (l)
        for (n in t) {
          if (
            ...
            !zt(s ? n : r + (a ? "." : "#") + n, e.forced) && void 0 !== o)
          ) {
    ...
    return function (p, L, t, B) {
      ...
      function Z(e) {
        ...
        if (
          ...
          if ((ut(), (Ce = Ce || zt()).calculateSwipeSpeed("x"), Te))
            ...
            if (!y)
              return "swipe" !== e
                ? void Vt()
                : void (!Fe && v > f.currItem.fitRatio && qt(Ce));
          }
      }
      var X,
        K,
        ...
        B = {
          ...
          setScrollOffset: function (e, t) {
            (qe.x = e), (be = qe.y = t), C("updateScrollOffset", qe);
          },
